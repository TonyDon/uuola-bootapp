...
public abstract  class FieldUtil {
    ...
    public static Date castSqlDate(Object v) {
        ...
        if (v instanceof String) {
            ...
            int pos = dateStr.indexOf(CHAR.CHAR_LINE);
            if (pos < 3) {
                return null;
            }
            if (len == 10) {
                // yyyy-MM-dd
                return DateUtil.parseDate(dateStr, DATE_FORMAT.YYYY_MM_DD);
            } else if (len == 19) {
                // yyyy-MM-dd HH:mm:ss
                return DateUtil.parseDate(dateStr, DATE_FORMAT.YYYY_MM_DD_HH_MM_SS);
            }
    ...
    public static java.sql.Timestamp castTimestamp(Object v) {
        ...
        if (v instanceof String) {
            ...
            if (len == 10) {
                // yyyy-MM-dd
                return new java.sql.Timestamp(DateUtil.parseTimeMillis(dateStr, DATE_FORMAT.YYYY_MM_DD));
            } else if (len == 19) {
                // yyyy-MM-dd HH:mm:ss
                return new java.sql.Timestamp(DateUtil.parseTimeMillis(dateStr, DATE_FORMAT.YYYY_MM_DD_HH_MM_SS));
            }
        }
